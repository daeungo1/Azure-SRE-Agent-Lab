...
> 실제 검증 결과는 **[README — E2E 실행 결과](README.md#6-실제로-되나요--e2e-실행-결과)** 참고
...
이 문서는 도입을 검토할 때 실제로 나오는 질문 순서대로 구성했습니다.

1. [인시던트가 발생하면 어떻게 조사하나요](#1-인시던트가-발생하면-어떻게-조사하나요)
2. [포털에서 무엇을 보게 되나요](#2-포털에서-무엇을-보게-되나요)
3. [조사 품질은 무엇이 결정하나요](#3-조사-품질은-무엇이-결정하나요)
4. [우리 방식을 어떻게 담나요](#4-우리-방식을-어떻게-담나요)
5. [권한과 승인은 어떻게 통제하나요](#5-권한과-승인은-어떻게-통제하나요)
6. [어떤 Azure 서비스와 연결되나요](#6-어떤-azure-서비스와-연결되나요)
7. [함께 생성되는 리소스는 무엇인가요](#7-함께-생성되는-리소스는-무엇인가요)
8. [비용은 어떻게 발생하나요](#8-비용은-어떻게-발생하나요)
9. [보안과 네트워크는 어떻게 통제하나요](#9-보안과-네트워크는-어떻게-통제하나요)
10. [도입 전에 무엇을 확인해야 하나요](#10-도입-전에-무엇을-확인해야-하나요)
11. [알아두어야 할 제한 사항은 무엇인가요](#11-알아두어야-할-제한-사항은-무엇인가요)
12. [참고 자료](#12-참고-자료)

---

## 1. 인시던트가 발생하면 어떻게 조사하나요
