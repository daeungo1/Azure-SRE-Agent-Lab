...
1. [설정하면 무엇이 달라지나요](#1-설정하면-무엇이-달라지나요)
2. [각 기능은 어떤 문제를 해결하나요](#2-각-기능은-어떤-문제를-해결하나요)
3. [우리 환경에는 어떻게 적용하나요](#3-우리-환경에는-어떻게-적용하나요)
4. [어떤 기능이 외부 연동을 필요로 하나요](#4-어떤-기능이-외부-연동을-필요로-하나요)
5. [장애가 나면 이 기능들이 어떻게 맞물리나요](#5-장애가-나면-이-기능들이-어떻게-맞물리나요)
6. [항목을 직접 추가하려면 어떻게 하나요](#6-항목을-직접-추가하려면-어떻게-하나요)
7. [되돌리려면 어떻게 하나요](#7-되돌리려면-어떻게-하나요)
...
> [권한 구조 — 조사와 조치의 경계](../README.md#권한-구조--조사와-조치의-경계)
...
Lab 이 배포되어 있어야 합니다 ([어떻게 배포하나요](../README.md#3-어떻게-배포하나요)).
...
| 7 | [장애 주입 시나리오](../README.md#5-무엇을-실습하나요) | 1~6 이 한 번의 장애에서 실제로 맞물리는 과정 |

---

## 6. 항목을 직접 추가하려면 어떻게 하나요
...
환경 전체를 삭제하려면 [README — 8. 정리](../README.md#8-다-쓰고-나면-어떻게-정리하나요) 를 따르세요.
...
| Automation | **0** | **3** |
| Connectors | 0 | 0 → *opt-in, [4장](#4-어떤-기능이-외부-연동을-필요로-하나요) 참고* |
...
[README — 7. 다시 시연하려면](../README.md#7-다시-시연하려면-무엇을-되돌려야-하나요)
